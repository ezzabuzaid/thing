...
export default {
  'GET /schedules/connectors': {
    ...
    output: [
      http.Ok<outputs.ListScheduleConnectors>,
      http.BadRequest<outputs.ListScheduleConnectors400>,
    ...
    async dispatch(
      input: z.input<typeof schedules.listScheduleConnectorsSchema>,
      options: {
        signal?: AbortSignal;
  ...
  'DELETE /schedules/{id}': {
    ...
    output: [
      http.Ok<outputs.ArchiveSchedule>,
      http.BadRequest<outputs.ArchiveSchedule400>,
      http.Unauthorized<outputs.UnauthorizedErr>,
    ],
    ...
    async dispatch(
      input: z.input<typeof schedules.archiveScheduleSchema>,
      options: {
        signal?: AbortSignal;
        interceptors: Interceptor[];
        fetch: z.infer<typeof fetchType>;
